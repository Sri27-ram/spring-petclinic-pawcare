...
public class PawcareClinicIntegrationTests {
	...
	public static void main(String[] args) {
		SpringApplication.run(PawcareClinicApplication.class, "--spring.docker.compose.lifecycle-management=NONE");
	}
