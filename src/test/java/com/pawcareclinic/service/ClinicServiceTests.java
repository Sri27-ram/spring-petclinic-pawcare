...
package com.pawcareclinic.service;
...
import com.pawcareclinic.owner.Owner;
import com.pawcareclinic.owner.OwnerRepository;
import com.pawcareclinic.owner.Pet;
import com.pawcareclinic.owner.PetType;
import com.pawcareclinic.owner.PetTypeRepository;
import com.pawcareclinic.owner.Visit;
import com.pawcareclinic.vet.Vet;
import com.pawcareclinic.vet.VetRepository;
...
class ClinicServiceTests {
	...
	void shouldFindOwnersByLastName() {
		Page<Owner> owners = this.owners.findByLastNameStartingWith("Whitaker", pageable);
		assertThat(owners).hasSize(2);

		owners = this.owners.findByLastNameStartingWith("Whitakerr", pageable);
	...
	void shouldFindSingleOwnerWithPet() {
		...
		assertThat(owner.getLastName()).startsWith("Whitaker");
	...
	void shouldFindVets() {
		...
		assertThat(vet.getLastName()).isEqualTo("Alvarez");
